...
title_name = 'Translation only dataset';

% training
[Coef, X, Y, para_K, para_Kp] = Calibration_Training([fk_t_train; fk_r_train], [ee_t_train; ee_r_train], fk_t_train, ee_t_train, order);

% fitting
[FK_original, FK_calibrated, FK_groundtruth] = Calibration_Fitting(fk_t_test, ee_t_test, order, Coef, X, Y, para_K, para_Kp);
